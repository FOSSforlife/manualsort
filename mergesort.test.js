...
const sortedArr1 = functions.main({compareFunc: functions.promptFake.get});
const sortedArr2 = functions.main({compareFunc: functions.promptFake.get});
const sortedArr3 = functions.main({compareFunc: functions.promptFake.get});
